...
var (
	...
	ErrGetExcusion     = errors.New("Ошибка при получении данных экскурсии")

	ErrGetUserById  = errors.New("Ошибка при получении пользователя")
	ErrUserNotFound = errors.New("Пользователь не найден")

	ErrSendCodeEmail     = errors.New("Ошибка при отправке кода подтверждения на почту")
	ErrCheckCodeEmail    = errors.New("Ошибка при проверке кода подтверждения")
